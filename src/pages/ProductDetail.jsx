...
const ProductDetail = () => {
  ...
  return (
    <>
      <div
        className="container mx-auto px-4 md:px-8 bg-gray-900 min-h-screen rounded-2xl shadow-2xl my-8 p-6 md:p-12 border border-gray-800 cursor-pointer 
      "
      >
        <Link to={"/"}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-1">
          <div className="w-full">
            <img
              src={product?.image}
              alt={product?.name}
              className="w-96 h-96 object-cover rounded-2xl shadow-gray-950/50
          ...
          <div className="flex flex-col justify-between">
            ...
            <h2 className="text-xl font-bold text-orange-200 mb-2 border-b border-e-orange-900/50 pb-2 flex items-center space-x-2">
            ...
            <div className="mt-5 space-y-4 flex justify-center items-center flex-col">
              ...
              onClick={()=>addToCart(product)}
                className=" w-full py-3 bg-orange-600 text-white font-bold rounded-full shadow-lg shadow-orange-800/50 
        cursor-pointer hover:bg-orange-700 transition duration-300 flex items-center justify-center space-x-2 transform hover:ring-4 
        hover:ring-pink-600/50 uppercase tracking-wider"
              >
                <ShoppingCart className="w-6 h-6" />
                <span>Add to Cart</span>
              </button>

              <Link to={'/'}className=" w-full py-3 border-2 border-orange-600 text-orange-400 font-bold rounded-full shadow-lg  
        cursor-pointer hover:bg-orange-900/50 transition duration-300 flex items-center justify-center space-x-2 transform hover:ring-4 
        hover:ring-pink-600/50 uppercase tracking-wider"
              >
              Keep Shopping
              </Link>
